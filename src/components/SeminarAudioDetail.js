...
function SeminarAudioDetail({ subPlaylist, onBack, initialAudioId }) {
  ...
  const getStorageKey = () => {
    const src = subPlaylist?.audios[currentAudio]?.audioUrl;
    ...
    return (
      <div className="audio-detail-container">
        <div className="error-message">
          <h2>Sub-playlist not found</h2>
          <button onClick={onBack} className="back-link">
            <ArrowLeft size={16} weight="bold" /> Back to Sub-Playlists
          </button>
        </div>
      </div>
    );
      ...
      <div className="audio-layout">
        ...
        <div className="main-audio-section">
          <div className="audio-player-wrapper">
            ...
            <audio
              ...
              onEnded={handleEnded}
            >
              <source src={subPlaylist.audios[currentAudio].audioUrl} type="audio/mpeg" />
          ...
          <div className="main-audio-info">
            <h2>{subPlaylist.audios[currentAudio].title}</h2>
            <div className="audio-meta">
              <span><CalendarBlank size={16} /> {subPlaylist.audios[currentAudio].date || 'Date N/A'}</span>
              <span><Clock size={16} /> {subPlaylist.audios[currentAudio].duration || 'Duration N/A'}</span>
            </div>
          </div>
          ...
          <div className="transcription-section">
            ...
            {subPlaylist.audios[currentAudio].hasTranscription ? (
        ...
        <div className="playlist-sidebar">
          <div className="playlist-sidebar-header">
            ...
            <span>{currentAudio + 1} / {subPlaylist.audios.length}</span>
          </div>
          ...
          <div className="playlist-items">
            {filteredAudios.map((audio, index) => {
              ...
              const originalIndex = subPlaylist.audios.findIndex(a => a.id === audio.id);
              return (
                <div
                  key={audio.id}
...
export default SeminarAudioDetail;
